...
\***************************************************************/
{
  ...
  MPI_Get_address(&tempStruct.memLoc, &startaddress);
  MPI_Get_address(&tempStruct.op, &address);
  systemStruct_displacements[1] = address - startaddress;
  MPI_Get_address(&tempStruct.in, &address);
  systemStruct_displacements[2] = address - startaddress;

  // build the mpi datatype mpi_expOps
  MPI_Type_create_struct(3, systemStruct_length, systemStruct_displacements, systemStruct_datatypes, mpi_expOps);
