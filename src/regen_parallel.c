...
\***************************************************************/
{
  ...
  MPI_Get_address(&tempRegen.num_levels, &startaddress);
  MPI_Get_address(&tempRegen.num_funcs, &address);
  regen_int_displacements[1] = address - startaddress;
  MPI_Get_address(&tempRegen.num_variables, &address);
  regen_int_displacements[2] = address - startaddress;
  MPI_Get_address(&tempRegen.num_var_gps, &address);
  regen_int_displacements[3] = address - startaddress;
  MPI_Get_address(&tempRegen.PPD_int, &address);
  regen_int_displacements[4] = address - startaddress;
  MPI_Get_address(&tempRegen.patch_rows, &address);
  regen_int_displacements[5] = address - startaddress;
  MPI_Get_address(&tempRegen.patch_cols, &address);
  regen_int_displacements[6] = address - startaddress;
  MPI_Get_address(&tempRegen.curr_precision, &address);
  regen_int_displacements[7] = address - startaddress;
  MPI_Get_address(&tempRegen.num_comp_d, &address);
  regen_int_displacements[8] = address - startaddress;
  MPI_Get_address(&tempRegen.totalLength, &address);
  regen_int_displacements[9] = address - startaddress;
  MPI_Get_address(&tempRegen.noChanges, &address);
  regen_int_displacements[10] = address - startaddress;
  MPI_Get_address(&tempRegen.numSubFuncs, &address);
  regen_int_displacements[11] = address - startaddress;
  MPI_Get_address(&tempRegen.numInts, &address);
  regen_int_displacements[12] = address - startaddress;

  // build the mpi datatype mpi_regen_int
  MPI_Type_create_struct(13, regen_int_length, regen_int_displacements, regen_int_datatypes, mpi_regen_int);
...
\***************************************************************/
{
  ...
  // calculate displacements
  regen_int_displacements[0] = 0;
  MPI_Get_address(&tempRegen.level, &startaddress);
  MPI_Get_address(&tempRegen.depth, &address);
  regen_int_displacements[1] = address - startaddress;
  MPI_Get_address(&tempRegen.useIntrinsicSlice, &address);
  regen_int_displacements[2] = address - startaddress;
  MPI_Get_address(&tempRegen.B_rows, &address);
  regen_int_displacements[3] = address - startaddress;
  MPI_Get_address(&tempRegen.B_cols, &address);
  regen_int_displacements[4] = address - startaddress;
  MPI_Get_address(&tempRegen.p_size, &address);
  regen_int_displacements[5] = address - startaddress;
  MPI_Get_address(&tempRegen.num_comp_d, &address);
  regen_int_displacements[6] = address - startaddress;
  MPI_Get_address(&tempRegen.totalLength, &address);
  ...
  MPI_Type_create_struct(8, regen_int_length, regen_int_displacements, regen_int_datatypes, mpi_regenLevel_int);
